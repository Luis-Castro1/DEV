            ...
            {categorias.map((category) => (
                <a key={category.id} className="cursor-pointer" href="">
                    ...
                    <div className="flex justify-center  overflow-hidden">
                        <img className="ms-auto sm:ms-0 rounded-[15px] hover:scale-105 sm:hover:scale-110 transition-all duration-200 w-[90%] h-[440px] sm:w-[90%] sm:h-[480px] md:w-[90%] md:h-[490px] max-w-[95%] max-h-[490px]" src={category.image}
                            width="50%" alt="" />
                    </div>
                </a>
            ))}
