    ...
    return (
        <>
            ...
            <div className='w-full'>
                <p className="font-darker-grotesque font-normal text-3xl mx-3 my-2">Recomendados para ti </p>
            </div>
            ...
            {recomendation.map((p) => (
                ...
                <div key={p.id} className="relative overflow-hidden rounded-[20px] my-10 cursor-pointer font-darker-grotesque font-normal bg-black">
